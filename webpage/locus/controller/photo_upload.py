...
@locus.route('/photo/upload', methods=['POST'])
@login_required
def upload_photo():
...
@locus.route('/photo/update/<locus_id>', methods=['POST'])
@login_required
...
@locus.route('/photo/update/<locus_id>')
@login_required
def update_photo_form(locus_id):
...
@locus.route('/photo/remove/<locus_id>')
@login_required
def remove(locus_id):
